...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="https://v4.bootcss.com/docs/examples/dashboard/#">Company name</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://v4.bootcss.com/docs/examples/dashboard/#" toggle-data="/category/index">
...
<nav style="text-align: center;" class="navbar navbar-dark fixed-bottom bg-dark flex-md-nowrap p-0 shadow">
	<font color="white" >此网站为个人所有,版权所有为Mr.陈,侵权必究,</font>
</nav>
